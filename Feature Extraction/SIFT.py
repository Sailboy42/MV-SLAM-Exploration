...
# Load two images of the same scene from the Images/ folder
...
cv.imwrite(os.path.join(OUTPUT_DIR, "out_detection_sift_f0.png"), cv.drawKeypoints(I0, k0, None,
          flags=cv.DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS))
cv.imwrite(os.path.join(OUTPUT_DIR, "out_detection_sift_f1.png"), cv.drawKeypoints(I1, k1, None,
          flags=cv.DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS))
...
cv.imwrite(os.path.join(OUTPUT_DIR, "out_matches_sift.png"), match_img)
